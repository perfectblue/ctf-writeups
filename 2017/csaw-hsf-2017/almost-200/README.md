...
This question is DIRECTLY stolen from CSAW CTF 2017 from two weeks ago. So we use someone else's writeup (literally, `import solution`) and get the flag.

the writeups are already available, so we simply adapt [their solution](https://github.com/liamh95/CTF-writeups/tree/master/CSAW17/AlmostXOR) and apply it to this problem.
